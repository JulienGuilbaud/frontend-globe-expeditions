// 1. Coordonnées de ton siège social à Lévis
const LEVIS = { lat: 46.8021, lng: -71.1753, name: "Mic Performance - Lévis, QC" };

// 2. Destinations réelles pour tes expéditions de motocross
const destinations = [
...
// 3. Villes mondiales pour dessiner les continents (Points orange/or)
...
const pointsData = [
    ...
    { lat: LEVIS.lat, lng: LEVIS.lng, size: 1.2, color: '#ffffff' } 
];

// 4. Arcs d'expédition (Blancs lumineux)
...
// 6. Matériau pour un rendu sombre et profond
const globeMaterial = myGlobe.globeMaterial();
globeMaterial.color.set('#0d3b44'); 
